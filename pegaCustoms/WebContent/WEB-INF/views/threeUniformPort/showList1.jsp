...
<body>
	<div class="easyui-layout" style="width:80%;height:100%;">
		...
		<div data-options="region:'center',title:'系统设置 >选查参数设置',iconCls:'icon-ok'">
			<span style="background-color:#EBF2FC;text-align:center;font-size:12px;">选查参数列表</span>
			<form action="http://localhost:8080/pegaCustoms/maintenance/save" id="form">
				<table  id="table" title="选查参数列表" style="width:100%">
				<tbody>
			...
			<table id="table_dg" class="easyui-datagrid" title="选查参数维护表" style="width:99%;height:440px;" fitColumns="true" toolbar="#tb"
